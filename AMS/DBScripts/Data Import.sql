...
IF NOT EXISTS(Select * FROM AspNetUsers Where UserName ='Admin')
	INSERT INTO AspNetUsers(Id, UserName,PasswordHash,NormalizedUserName,AccessFailedCount,EmailConfirmed,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnabled) Values
	(@UserId,'Admin','AQAAAAIAAYagAAAAEKTZ/LyaD/jMUOPVuKBVLkdaXActb20JNAnuG3ODBO/1H65ORgWAySm0GdnC1UJgxQ==','Admin User',0,1,1,0,0);
